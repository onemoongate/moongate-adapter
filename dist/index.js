...
var MoongateWalletAdapter2 = class extends BaseSignInMessageSignerWalletAdapter {
  constructor(config) {
    ...
    this._logoDataUri = "Default";
    this._buttonLogoUri = "https://i.ibb.co/NjxF2zw/Image-3.png";
    ...
    if (config == null ? void 0 : config.authMode) {
      ...
      if (config.authMode === "Apple") {
        this.name = "Sign in with Apple";
        this.icon = `data:image/svg+xml;base64,`;
      }
      if (config.authMode === "Twitter") {
        this.name = "Sign in with Twitter";
    ...
    if (config == null ? void 0 : config.logoDataUri) {
      this._logoDataUri = config.logoDataUri;
    }
    if (config == null ? void 0 : config.buttonLogoUri) {
